  ...
  return (
    <div className="tracker-card">
      ...
      {order ? <div className={styles.summary}>
        ...
        {order.status === "awaiting_payment" && order.payments.reservation === "pending" ? <p className={styles.hint}>Your reservation proof is under review. Your launch slot stays held while Brick Buddy reviews it.</p> : null}
